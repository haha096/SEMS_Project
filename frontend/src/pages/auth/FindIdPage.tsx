...
export default function FindIdPage() {
    ...
    const submit = async (e: React.FormEvent) => {
        ...
        try {
            setLoading(true);
            const url = tab === "email" ? "/api/user/find-id" : "/api/user/find-id/phone";
            const body = tab === "email" ? { name, email } : { name, phone };
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2">
                    ...
                    <CardContent className="p-7 md:p-10">
                        ...
                        <div className="mb-4 flex gap-2">
                            <Button variant={tab === "email" ? "default" : "secondary"} onClick={() => setTab("email")}>이메일로 찾기</Button>
                            <Button variant={tab === "phone" ? "default" : "secondary"} onClick={() => setTab("phone")}>휴대폰으로 찾기</Button>
                        </div>
                            ...
                            {tab === "email" ? (
                                ...
                                <div>
                                    ...
                                    <div className="relative mt-2">
                                        ...
                                        <Input className="pl-10 h-11" placeholder="010-0000-0000" value={phone} onChange={(e) => setPhone(e.target.value)} required />
                                    </div>
                                </div>
                            )}
